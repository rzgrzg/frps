...
RUN tar -zxf frp_${FRP_VERSION}_linux_amd64.tar.gz  --strip-components=1  frp_${FRP_VERSION}_linux_amd64/frps -C /usr/local/frp \
    && tar -zxf frp_${FRP_VERSION}_linux_amd64.tar.gz  --strip-components=1  frp_${FRP_VERSION}_linux_amd64/frps.ini -C /usr/local/frp/conf \
