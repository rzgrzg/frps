...
RUN tar -zxf frp_${FRP_VERSION}_linux_amd64.tar.gz frp_${FRP_VERSION}_linux_amd64/frps -C /usr/local/frp --strip=1 \
    && tar -zxf frp_${FRP_VERSION}_linux_amd64.tar.gz frp_${FRP_VERSION}_linux_amd64/frps.ini -C /usr/local/frp/conf --strip=1 \
